                    ...
                    <div className="-space-y-px rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="relative block w-full appearance-none rounded-none border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-zinc-100 bg-white dark:bg-zinc-900 placeholder-zinc-500 dark:placeholder-zinc-400 focus:z-10 focus:border-zinc-500 focus:ring-zinc-500 focus:outline-none sm:text-sm transition-colors"
